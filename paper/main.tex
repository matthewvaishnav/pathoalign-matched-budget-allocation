...
This result should not be interpreted as a universal law for all datasets or encoders. It is a controlled allocation study under the PathoAlign evaluation design. Its role is to constrain training-budget choices, not to claim diagnostic performance.
